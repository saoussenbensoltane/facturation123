...
public class ConventionResponse {
    ...
    public ConventionResponse(String application, String structure, BigDecimal price, BigDecimal nbr_reel, BigDecimal nbr_Min, BigDecimal nbr_Max, BigDecimal totalAmount,LocalDate dateSignature,LocalDate dueDate) {
